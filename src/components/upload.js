    ...
    return(
        <div className="upload">
              <div className='formControl'>
                ...
                <button onClick={() => {
                    setApolloError('')
                    setFormToShow('movie')}} className={formToSow ==='movie'? 'activeForm': ''}>Movie
                </button>
                <button onClick={() => {
                    setApolloError('')
                    setFormToShow('music')}} className={formToSow ==='music'? 'activeForm': ''}>Music
                </button>
                <button onClick={() => {
                    setApolloError('')
                    setFormToShow('series')}} className={formToSow ==='series'? 'activeForm': ''}>Series
                </button>
                <button onClick={() => {
                    setApolloError('')
                    setFormToShow('table')}} className={formToSow ==='table'? 'activeForm': ''}>Table
                </button>
                <button onClick={() => {
                    setApolloError('')
                    setFormToShow('fixture')}} className={formToSow ==='fixture'? 'activeForm': ''}>Fixture
                </button>
            </div>
